...
[![Tests](https://img.shields.io/badge/tests-110%20passed-brightgreen)](https://github.com/DD542/sentinel)
...
Suite de tests : **110 tests unitaires, d'intégration et d'API, tous verts** en CI sur Python 3.11 et 3.12.
...
**Répartition des 110 tests :** détection L1 déterministe (22), normalisation L0 (13), vault FPE (16), chaîne d'audit (9), intégration moteur (9), API FastAPI (24), passerelle OpenAI-compatible et admin (9), révocation et rate-limiting (8).
...
- **Durcissement production.** Pas encore d'authentification sur le dashboard ni sur le WebSocket temps réel.
...
- [x] Suite de 110 tests, dont 41 tests d'intégration API (TestClient FastAPI)
...
Test suite: **110 unit, integration and API tests, all green** in CI on Python 3.11 and 3.12.
...
- **Production hardening.** No authentication on the dashboard or the real-time WebSocket yet.
...
- [x] 110-test suite, including 41 API integration tests (FastAPI TestClient)
